...
export default function DistanceScreen() {
  ...
  async function handleSearchAddress() {
    ...
    try {
      ...
      Alert.alert("Error", "Could not search that location. Please try again.");
    } finally {
      setSearchLoading(false);
    }
  }

  function handleSelectResult(item: { label: string; latitude: number; longitude: number }) {
      ...
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.subtitle}>Discover new places near you</Text>
            ...
            <View style={styles.sliderCard}>
              ...
              <View style={styles.sliderRow}>
                ...
                <Slider
                  ...
                  step={0.5}
                  value={localRadius}
                  onValueChange={(v) => setLocalRadius(Math.round(v * 2) / 2)}
                  onSlidingComplete={(v) => setRadiusMiles(Math.round(v * 2) / 2)}
              ...
              <Text style={styles.sliderSubtext}>
                Showing places within {localRadius} mile{localRadius !== 1 ? "s" : ""}
              </Text>
            </View>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalCard}>
            ...
            <TouchableOpacity style={styles.cancelBtn} onPress={handleCloseSearch}>

...
function preferencesReducer(state: DietaryState, action: Action): DietaryState {
  switch (action.type) {
    case "TOGGLE_DIETARY":
      return {
        dietaryRestrictions: state.dietaryRestrictions.includes(action.value)
          ? state.dietaryRestrictions.filter((item) => item !== action.value)
  ...
  return (
    <AuthBackground variant="tl">
      <ScrollView contentContainerStyle={styles.center}>
        ...
        >
          <Text style={styles.backButtonText}>{"Back to Accessibility"}</Text>
        </TouchableOpacity>

...
export default function MapScreen() {
   ...
   const [markerDetailModalVisible, setMarkerDetailModalVisible] =
      useState<boolean>(false);
   ...
   function getDistanceAndTimeToPlace(place: Place): {
      distance: number;
      time: string;
      display: string;
   } {
      ...
      <View style={styles.container}>
               ...
               <View style={styles.distanceDisplay}>
                  <View>
                     <Text style={styles.distanceText}>
                        Travel Distance: {routeDistance} miles
                     </Text>
                     <Text style={styles.trainTimeText}>
                        🚂 By Train: {trainTravelTime}
                     </Text>
                  </View>
         ...
         >
            <View style={styles.modalOverlay}>
               ...
               />
               <View
                  style={[styles.modalCard, { marginBottom: keyboardHeight }]}
               >
               ...
               {selectedMarker && (
                  <View style={styles.modalCard}>
                        ...
                        <>
                           <View style={styles.travelInfoContainer}>
                              <Text style={styles.travelInfoText}>
                                 🚂{" "}
                                 {
                                    getDistanceAndTimeToPlace(selectedMarker)
                                       .display
                                 }
                              </Text>
                           </View>
                     ...
                     <View style={styles.modalButtons}>
                        ...
                        >
                           <Text
                              style={[styles.saveBtnText, styles.deleteBtnText]}
                           >
                              Delete
                           </Text>
                        </TouchableOpacity>

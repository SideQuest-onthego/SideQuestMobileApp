...
// function to determine distance between POIs
...
// heuristics based ordering engine V3
...
// unless 5 places are selected, results are null
export function generateItineraryResult(
   ...
   // returns completed itinerary object
   return {
      id: `itin-${Date.now()}`,
...
// builds Itinerary View by appending places via placeId as individual stops
